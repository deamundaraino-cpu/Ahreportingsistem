...
export async function POST(req: NextRequest) {
    ...
    const {
        nombre, descripcion, cliente_id, layout, filters, calculated_fields,
    ...
    if (source_report_id) {
        ...
        const srcFilters = { ...((typeof src.filters === 'object' && src.filters ? src.filters : {}) as Record<string, unknown>) }
