    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-foreground">Nuevo cliente manual</h2>
        ...
        <div className="px-6 py-4 border-b border-border flex items-center gap-3">
          ...
          {clientes && clientes.length > 0 && (
            <span className="text-[11px] text-muted-foreground">
              {(clientes as ReportUtmCliente[]).filter((c) => c.public_cliente_id).length} de
              plataforma
              {' · '}
            ...
            <tbody className="divide-y divide-border">
              {(clientes as ReportUtmCliente[]).map((c) => (
                <tr key={c.id} className="hover:bg-accent">
                  ...
                  <td className="px-6 py-3 text-xs font-mono text-muted-foreground">{c.slug}</td>
                  <td className="px-6 py-3">
