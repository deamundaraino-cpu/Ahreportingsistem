                ...
                <article className="space-y-8">
                    ...
                    <Section title="1. Aceptación de los términos">
                        <p>
                            ...
                            («la Plataforma», «el Servicio», «nosotros»), una herramienta de generación de reportes
                            que consolida métricas de campañas publicitarias de plataformas de terceros como Meta
                            (Facebook e Instagram), TikTok y Hotmart.
                        </p>
                        <p>
                            Al acceder o utilizar la Plataforma, aceptas quedar vinculado por estos Términos. Si no
                            estás de acuerdo con ellos, no debes utilizar el Servicio.
                        </p>
                    </Section>
                    ...
                    <Section title="2. Descripción del servicio">
                        <p>
                            ...
                            sus campañas obtenidas a través de las API oficiales de cada proveedor. El acceso a los
                            datos publicitarios se realiza en modo de solo lectura.
                        </p>
                    </Section>
                    ...
                    <Section title="4. Conexiones con plataformas de terceros">
                        <p>
                            Al conectar una cuenta de Meta, TikTok u otra plataforma, nos autorizas a acceder a tus
                            datos publicitarios con el único fin de generar tus reportes. Tu uso de dichas
                    ...
                    <Section title="9. Limitación de responsabilidad">
                        <p>
                            ...
                            tipo. En la máxima medida permitida por la ley, no seremos responsables por daños
                            indirectos, incidentales o consecuentes derivados del uso o la imposibilidad de uso de
                            la Plataforma, ni por decisiones tomadas con base en los reportes generados.
                        </p>
                    </Section>
