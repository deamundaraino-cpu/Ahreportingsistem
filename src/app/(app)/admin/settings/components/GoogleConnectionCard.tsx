...
export function GoogleConnectionCard({ connected, email }: Props) {
    ...
    const handleDisconnect = () => {
        if (!confirm('¿Desconectar la cuenta de Google de la agencia? Los clientes dejarán de sincronizar GA4/Sheets por OAuth.')) return
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-zinc-950/60 p-3 rounded">
                        ...
                        <div className="flex gap-2">
                            <a href="/api/auth/google">
                                <Button variant="outline" size="sm" disabled={isPending}>Reconectar</Button>
                            </a>
