...
const METRIC_CATALOG = [
    ...
    },
    {
        ...
        metrics: [
            ...
            { id: 'meta_roas',                        label: 'ROAS (solo Meta)',       desc: 'Ventas netas / gasto de Meta. Para el ROAS de toda la inversión usa "ROAS Total".' },
    ...
    },
    {
        ...
        metrics: [
            ...
            { id: 'total_roas',              label: 'ROAS Total',             desc: 'Neto total / inversión total (Meta + TikTok)' },
            { id: 'total_roi',               label: 'ROI Total',              desc: '(Neto total - inversión total) / inversión total' },
            { id: 'total_dinero_bolsa',      label: 'Dinero en Bolsa Total',  desc: 'Neto total - inversión total (Meta + TikTok)' },
            { id: 'total_costo_compra',      label: 'Costo/Compra Total',     desc: 'Inversión total / compras del principal' },
        ],
    },
    {
