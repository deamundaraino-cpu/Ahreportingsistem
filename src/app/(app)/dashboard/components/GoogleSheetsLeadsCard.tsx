  ...
  if (error || !dailyData || dailyData.length === 0) {
    return (
      <Card className="bg-card border-border">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">{error || 'No hay datos de leads disponibles'}</p>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold font-mono tabular-nums text-foreground">{stats.total_hoy}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold font-mono tabular-nums text-green-600 dark:text-green-500">{stats.calificados_hoy}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold font-mono tabular-nums text-indigo-600 dark:text-indigo-500">{stats.tasa_hoy.toFixed(1)}%</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold font-mono tabular-nums text-foreground">{stats.total_7dias}</p>
