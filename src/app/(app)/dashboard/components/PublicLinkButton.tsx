            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="bg-background border-border text-foreground sm:max-w-md max-h-[85vh] overflow-y-auto">
                    ...
                    <div className="border-t border-border pt-4 mt-2">
                        <p className="text-xs text-muted-foreground mb-3 font-medium">Pestañas visibles en el link público:</p>
                        <div className="space-y-1.5 max-h-56 overflow-y-auto pr-1">
                            {tabs.length === 0 ? (
                                <p className="text-xs text-muted-foreground/70 italic py-2">No hay pestañas configuradas aún.</p>
                            ) : (
                                tabs.map(tab => {
