...
import {
    parseSeleccion, alternarValor, componerFilas, tieneComa,
...
export function SelectorDeValores({
    dimension, value, onChange, clienteId, dateFrom, dateTo,
    source, queryBase, modo = 'popover', disabled, placeholder,
}: Props) {
    ...
    const { valores: listados, total, truncado, cargando, motivo, recargar } = useValoresDistintos({
        queryBase, dimension, clienteId, dateFrom, dateTo, source,
        busqueda,
        activo: abierto,
    })
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    placeholder={truncado ? `Buscar entre ${total.toLocaleString('es-CO')} valores…` : 'Buscar…'}
            ...
            {truncado && (
                <p className="text-[11px] text-muted-foreground border-t border-border pt-1.5">
                    Se muestran los más frecuentes de {total.toLocaleString('es-CO')}. Busca para encontrar el resto.
                </p>
            )}
        ...
        <div className="relative" ref={contenedor}>
            ...
            >
                ...
                {seleccion.length > 0 && (
                    <span
                        ...
                        onKeyDown={e => { if (e.key === 'Enter') { e.stopPropagation(); limpiar() } }}
            ...
            {abierto && (
                <>
                    ...
                    <div className="absolute z-50 mt-1 w-full min-w-64 rounded-md border border-border
