                ...
                <div className="flex items-center gap-3">
                    {clienteName && (
                        <div className="flex items-center gap-2">
                            {clienteLogo && (
                                // eslint-disable-next-line @next/next/no-img-element
                                <img src={clienteLogo} alt={clienteName} className="h-7 w-auto max-w-[120px] object-contain" />
                            )}
                            <div className="text-right leading-tight">
                                <p className="text-[10px] uppercase tracking-wider text-muted-foreground">Informe para</p>
                                <p className="text-sm font-semibold" style={{ color: brand }}>{clienteName}</p>
                            </div>
                        </div>
                    )}
                    <button
