          ...
          {token ? (
            <>
              <p className="text-xs text-muted-foreground">
                Cualquiera con este link puede ver el informe en modo solo lectura (sin necesidad de
                iniciar sesión).
              </p>
              <div className="flex items-center gap-2">
                <input
            ...
            <>
              <p className="text-xs text-muted-foreground">
                Genera un link público de solo lectura para compartir este informe con clientes o tu
                equipo.
              </p>
              <button
                onClick={generate}
