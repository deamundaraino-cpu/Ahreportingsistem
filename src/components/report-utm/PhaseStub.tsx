    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 max-w-2xl">{description}</p>
            </div>
            ...
            <div className="rounded-2xl border border-dashed border-emerald-200 dark:border-emerald-500/20 bg-emerald-50/40 dark:bg-emerald-500/5 p-8">
                <div className="flex items-start gap-4">
                    <div className="h-12 w-12 rounded-xl flex items-center justify-center bg-white dark:bg-zinc-950 shadow-sm">
