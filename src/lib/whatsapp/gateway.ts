// Cliente HTTP del microservicio gateway de Baileys.
//
// El gateway es un proceso Node persistente (fuera de Vercel) que mantiene
// la conexión WebSocket con WhatsApp. Aquí solo lo llamamos por REST con un
// Bearer compartido. Mismo patrón de fetch + AbortController/timeout que
// src/lib/report-utm/outbound-emitter.ts (deliverOne).

import type { GatewayStatus, WhatsAppGroup } from './types';
