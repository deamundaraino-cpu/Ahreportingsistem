...
export const ADS_SOURCE: DataSource = {
  ...
  fields: [
    ...
    money(
      ...
      'spend',
      'Gasto total',
      'Dinero invertido en publicidad (Meta + TikTok) durante el período.',
      'inversion',
    ...
    money(
      ...
      'spend_meta',
      'Gasto Meta',
      'Dinero invertido en anuncios de Meta (Facebook e Instagram).',
      'inversion',
    ...
    money(
      ...
      'spend_tiktok',
      'Gasto TikTok',
      'Dinero invertido en anuncios de TikTok.',
      'inversion',
    ...
    measure(
      ...
      'impressions',
      'Impresiones',
      'Veces que se mostró un anuncio (una misma persona puede verlo varias veces).',
      'rendimiento',
    ...
    measure(
      ...
      'link_clicks',
      'Clics de enlace',
      'Clics que llevaron a la página de destino.',
      'rendimiento',
      { funnelStage: 40 }
    ),
    ...
    derived(
      ...
      'ctr',
      'CTR',
      'Porcentaje de personas que hicieron clic tras ver el anuncio. Mide qué tan atractivo es el anuncio.',
      'rendimiento',
      'ads.clicks / ads.impressions',
      { format: 'percent', nullUnless: ['ads.impressions'], recommended: true }
    ),
    derived(
      S,
      'cpc',
      'CPC',
      'Costo por clic: cuánto se paga, en promedio, por cada clic.',
      'rendimiento',
      'ads.spend / ads.clicks',
      { format: 'currency', nullUnless: ['ads.clicks'], recommended: true, direction: 'down' }
    ),
    derived(
      S,
      'cpm',
      'CPM',
      'Costo por cada mil impresiones del anuncio.',
      'rendimiento',
      'ads.spend / ads.impressions * 1000',
      { format: 'currency', nullUnless: ['ads.impressions'], recommended: true, direction: 'down' }
    ),
    derived(
      S,
      'frequency',
      ...
      'rendimiento',
      'ads.impressions / ads.reach',
      { format: 'ratio', nullUnless: ['ads.reach'], direction: 'down' }
    ),
    ...
    pixelEvent(
      ...
      'landing_page_views',
      'Vistas de landing',
      'Veces que la página de destino se cargó por completo tras un clic.',
      { funnelStage: 50 }
    ),
    pixelEvent(
      S,
      ...
      'Registros',
      'Registros completados que reporta el píxel de Meta.',
      { funnelStage: 75 }
    ),
    pixelEvent(
      S,
    ...
    pixelEvent(
      ...
      'post_reactions',
      'Reacciones',
      'Reacciones (me gusta y similares) en los anuncios.'
    ),
    ...
    pixelEvent(
      ...
      'adds_to_cart',
      'Añadir al carrito',
      'Veces que alguien añadió un producto al carrito, según el píxel.',
      { funnelStage: 80 }
    ),
    ...
    pixelEvent(
      ...
      'initiates_checkout',
      'Iniciar pago (Meta)',
      'Veces que alguien empezó un pago en la web, según el píxel de Meta.',
      { funnelStage: 85 }
    ),
    ...
    pixelEvent(
      ...
      'view_content',
      'Ver contenido',
      'Veces que alguien vio una página de producto o contenido clave, según el píxel.',
      { funnelStage: 78 }
    ),
    ...
    pixelEvent(
      ...
      'Veces que alguien guardó un producto en su lista de deseos.'
    ),
    pixelEvent(
      S,
      'contact',
    ...
    pixelEvent(
      ...
      'subscribe',
      'Suscripciones (píxel)',
      'Suscripciones registradas por el píxel de Meta.'
    ),
    pixelEvent(
      S,
      'start_trial',
      'Inicio de prueba',
      'Veces que alguien empezó un período de prueba.'
    ),
    ...
    pixelEvent(
      ...
      'Interacciones con la página, según el píxel.'
    ),
    ...
    pixelEvent(
      ...
      'conversions_tiktok',
      'Conversiones TikTok',
      'Conversiones que reporta TikTok para sus anuncios.',
      { column: 'tiktok_conversions' }
    ),
  ],
};
