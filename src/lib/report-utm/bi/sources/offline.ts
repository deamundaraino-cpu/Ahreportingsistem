...
export const OFFLINE_SOURCE: DataSource = {
  ...
  fields: [
    ...
    measure(
      S,
      'ventas',
      'Ventas offline (Sheet)',
      'Ventas que el equipo carga a mano en el Google Sheet del cliente.',
      'offline',
    ...
    money(
      S,
      'revenue',
      'Revenue offline (Sheet)',
      'Dinero de las ventas cargadas a mano en el Google Sheet del cliente.',
      'offline',
    ...
    measure(
      S,
      'total',
      'Conversiones offline (Sheet)',
      'Todas las filas de conversión del Google Sheet, sin distinguir leads de ventas.',
      'offline',
