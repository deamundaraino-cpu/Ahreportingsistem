...
export const CUENTA_SOURCE: DataSource = {
  ...
  fields: [
    ...
    measure(
      ...
      'ga_sessions',
      'Sesiones (GA4)',
      'Visitas al sitio web medidas por Google Analytics.',
      'ga4'
    ),
    ...
    money(
      S,
      'ventas_principal',
      'Ventas principal (neto)',
      'Facturación neta del producto principal.',
      'hotmart'
    ),
    money(
      S,
      'ventas_bump',
      'Ventas bump (neto)',
      'Facturación neta de los productos bump (añadidos en el checkout).',
      'hotmart'
    ),
    money(
      S,
      'ventas_upsell',
      'Ventas upsell (neto)',
      'Facturación neta de los upsells (ofertas posteriores a la compra).',
      'hotmart'
    ),
    measure(
      S,
      ...
      'Ventas principal (#)',
      'Cantidad de ventas del producto principal.',
      'hotmart'
    ),
    measure(
      S,
      'ventas_bump_count',
      'Ventas bump (#)',
      'Cantidad de ventas de productos bump.',
      'hotmart'
    ),
    measure(
      S,
      'ventas_upsell_count',
      'Ventas upsell (#)',
      'Cantidad de ventas de upsell.',
      'hotmart'
    ),
    money(
      S,
      'ventas_principal_bruto',
      'Ventas principal (bruto)',
      'Facturación del producto principal antes de comisiones.',
      'hotmart'
    ),
    money(
      S,
      'ventas_bump_bruto',
      'Ventas bump (bruto)',
      'Facturación de los bump antes de comisiones.',
      'hotmart'
    ),
    money(
      S,
    ...
    measure(
      ...
      'ventas_cerradas',
      'Ventas cerradas (#)',
      'Ventas cerradas que carga el equipo a mano en el dashboard.',
      'hotmart',
    ...
    derived(
      ...
      'hotmart',
      'cuenta.hotmart_revenue_calc / ads.spend',
      {
        format: 'ratio',
        nullUnless: ['ads.spend', 'cuenta.hotmart_revenue_calc'],
        goal: 'roas_min',
      }
    ),
    derived(
      ...
      'hotmart',
      'ads.spend / cuenta.hotmart_sales_calc',
      {
        format: 'currency',
        nullUnless: ['ads.spend', 'cuenta.hotmart_sales_calc'],
        direction: 'down',
        goal: 'cpa_max',
      }
    ),
    derived(
      ...
      'hotmart',
      '(cuenta.hotmart_revenue_calc - ads.spend) / ads.spend',
