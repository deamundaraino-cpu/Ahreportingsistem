...
export const SUBS_SOURCE: DataSource = {
    ...
    fields: [
        measure(S, 'active', 'Suscripciones activas',
            ...
            'subs', { agg: 'last' }),
        measure(S, 'delayed', 'Suscripciones atrasadas',
            'Suscripciones con el pago atrasado en la última foto disponible.', 'subs', { agg: 'last' }),
        measure(S, 'canceled', 'Suscripciones canceladas',
            'Suscripciones canceladas en la última foto disponible.', 'subs', { agg: 'last' }),
        measure(S, 'total', 'Suscripciones (total)',
            'Total de suscripciones registradas en la última foto disponible.', 'subs', { agg: 'last' }),
        money(S, 'mrr', 'MRR (valor recurrente)',
