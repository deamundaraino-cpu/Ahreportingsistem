...
export const HOTMART_SOURCE: DataSource = {
    ...
    fields: [
        ...
        measure(S, 'reembolsos', 'Reembolsos (#)',
            ...
            'hotmart', { agg: 'sum', column: 'reembolsos', direction: 'down' }),
        money(S, 'revenue_reembolsado', 'Facturación reembolsada',
            ...
            'hotmart', { column: 'revenue_reembolsado', direction: 'down' }),

        // ── Derivadas ────────────────────────────────────────────────────
        derived(S, 'tasa_reembolso', 'Tasa de reembolso',
            'Qué porcentaje de la facturación acabó devuelta. Cuanto MÁS BAJO, mejor.',
            'hotmart', 'hotmart.revenue_reembolsado / hotmart.revenue_neto',
            { format: 'percent', nullUnless: ['hotmart.revenue_neto'], direction: 'down' }),
        derived(S, 'roas', 'ROAS (Hotmart real)',
            ...
            'hotmart', 'hotmart.revenue_neto / ads.spend',
            ...
            { format: 'ratio', nullUnless: ['ads.spend', 'hotmart.revenue_neto'], recommended: true, goal: 'roas_min' }),
        derived(S, 'cpa', 'CPA (Hotmart real)',
            'Cuánto costó, en promedio, cada venta de Hotmart atribuida a la campaña. Cuanto MÁS BAJO, mejor.',
            'hotmart', 'ads.spend / hotmart.ventas',
            { format: 'currency', nullUnless: ['ads.spend', 'hotmart.ventas'], recommended: true, direction: 'down', goal: 'cpa_max' }),
        derived(S, 'ticket_medio', 'Ticket medio',
            'Facturación neta dividida entre el número de ventas: cuánto deja, en promedio, cada compra.',
            'hotmart', 'hotmart.revenue_neto / hotmart.ventas',
        ...
        dimension(S, 'oferta', 'Oferta (Hotmart)', 'sales_column', 'hotmart', { column: 'oferta_codigo', highCardinality: true }),
        dimension(S, 'producto', 'Producto (Hotmart)', 'sales_column', 'hotmart', { column: 'producto_nombre' }),
        dimension(S, 'pais', 'País (Hotmart)', 'sales_column', 'hotmart', { column: 'comprador_pais' }),
        dimension(S, 'metodo_pago', 'Método de pago', 'sales_column', 'hotmart', { column: 'pago_tipo' }),
    ],
}
