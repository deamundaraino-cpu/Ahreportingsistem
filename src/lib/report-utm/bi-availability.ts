...
export async function getMetricAvailability(
  ...
  for (const metric of Object.keys(METRIC_META) as BiMetric[]) {
    switch (metric) {
      case 'cpl':
        out[metric] = has('spend') && has('leads_count');
        break;
      case 'cpa':
        out[metric] = has('spend') && has('sales_count');
        break;
      case 'roas':
        out[metric] = has('spend') && has('revenue');
        break;
      case 'conversion_rate':
        out[metric] = has('leads_count') && has('sales_count');
        break;
      case 'cpc':
        out[metric] = has('spend') && has('clicks');
        break;
      case 'cpm':
        out[metric] = has('spend') && has('impressions');
        break;
      case 'ctr':
        out[metric] = has('clicks') && has('impressions');
        break;
      case 'frequency':
        out[metric] = has('impressions') && has('reach');
        break;
      case 'hotmart_revenue':
        out[metric] = hasHotmartRevenue(has);
        break;
      case 'hotmart_sales':
        out[metric] = hasHotmartSales(has);
        break;
      case 'hotmart_roas':
        out[metric] = has('spend') && hasHotmartRevenue(has);
        break;
      case 'hotmart_roi':
        out[metric] = has('spend') && hasHotmartRevenue(has);
        break;
      case 'hotmart_cpa':
        out[metric] = has('spend') && hasHotmartSales(has);
        break;
      ...
      case 'hm_roas':
        ...
        break;
      case 'hm_cpa':
        out[metric] = has('spend') && has('hm_ventas');
        break;
