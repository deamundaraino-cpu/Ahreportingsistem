...
const legitimo =
  '<p>Hola <strong>mundo</strong> y <em>algo</em></p><ul><li>uno</li></ul><a href="https://ejemplo.test">enlace</a>';
...
check(
  'rechaza url() con expresión',
  colorSeguro('red; background:url(https://evil.test/x)') === undefined
);
...
const escape = urlLogoSegura(
  "https://cdn.test/x.png'); } body { display:none } .x{ background:url('"
);
